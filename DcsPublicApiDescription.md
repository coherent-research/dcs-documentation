...
| format       | Specifies the format of the data that will be returned. The options are: standard, complete                                | Optional, default is **standard**. More options may be added in the future. Note that the format complete is not valid for virtual meters.                                                                                                                                                                                                                                                                                                                         |
...
| ----------- | --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| timestamp   | The UTC time corresponding to the reading.          |                                                                                                                                   |
| totalValue  | The total value of the reading                      | This will be a floating point number however it can potentially include a "NaN", "Infinity", or "-Infinity" string where relevant |
| periodValue | The period value of the reading                     | This will be a floating point number however it can potentially include a "NaN", "Infinity", or "-Infinity" string where relevant |
| status      | A set of flags indicating the status of the reading | See below                                                                                                                         |
